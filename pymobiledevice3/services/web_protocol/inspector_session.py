...
class InspectorSession:
    _ERROR_SUPPORT_MESSAGE = 'Message is not supported'
    ...
    async def _receive_loop(self):
        while True:
            ...
            if response_method == 'Target.dispatchMessageFromTarget':
                ...
                logger.error(self._ERROR_SUPPORT_MESSAGE, response)
                raise RuntimeError(self._ERROR_SUPPORT_MESSAGE)
    ...
    @staticmethod
    def _parse_undefined(result: Mapping) -> str:
        return 'undefined'
    ...
    def _parse_object(self, result: Mapping) -> Union[List, Mapping]:
        ...
        if result_class_name == 'Object' or not result_class_name:
            ...
            logger.error(self._ERROR_SUPPORT_MESSAGE)
            raise NotImplementedError(self._ERROR_SUPPORT_MESSAGE)
